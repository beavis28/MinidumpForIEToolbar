...
const CInterfaceProxyVtbl * const _MotleyFool_ProxyVtblList[] = 
{
    ( CInterfaceProxyVtbl *) &_IStockBarProxyVtbl,
    0
};

const CInterfaceStubVtbl * const _MotleyFool_StubVtblList[] = 
{
    ( CInterfaceStubVtbl *) &_IStockBarStubVtbl,
    0
};
...
const IID *  const _MotleyFool_BaseIIDList[] = 
{
    &IID_IDispatch,
    0
};
